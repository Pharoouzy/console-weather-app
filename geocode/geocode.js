...
var geocodeAddress = (address, callback) => {
    ...
    request({
        ...
        // second arg in stringify is user to filter properties, the 3rd arg is gonna format the JSON and u specify the amount of spaces u wanna use per indentation
